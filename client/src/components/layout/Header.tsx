      ...
      <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
        <div className="container _custom_container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="_header_nav_profile" onClick={() => setIsProfileOpen(!isProfileOpen)} style={{ cursor: 'pointer' }}>
              <div className="_header_nav_profile_image">
                <img src={user?.avatar || "/assets/images/profile.png"} alt="Image" className="_nav_profile_img" />
              </div>
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para">{user ? `${user.firstName} ${user.lastName}` : 'User'}</p>
                ...
                <div id="_prfoile_drop" className="_nav_profile_dropdown _profile_dropdown" style={{ display: 'block' }}>
                  <div className="_nav_profile_dropdown_info">
                    ...
                    <div className="_nav_profile_dropdown_info_txt">
                      <h4 className="_nav_dropdown_title">{user ? `${user.firstName} ${user.lastName}` : 'User'}</h4>
                  ...
                  <ul className="_nav_dropdown_list">
                    ...
                    <li className="_nav_dropdown_list_item">
                      <button onClick={() => logout()} className="_nav_dropdown_link" style={{ width: '100%', textAlign: 'left', border: 'none', background: 'none' }}>
                        <div className="_nav_drop_info">
                          <span>
              ...
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div className="_header_mobile_menu_top_inner">
                  ...
                  <div className="_header_mobile_menu_right">
                    <form action="" className="_header_form_grp">
