            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="_social_registration_content">
                ...
                <form className="_social_registration_form" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  {registerError && <div className="alert alert-danger p-2 mb-3" style={{ fontSize: '14px' }}>{registerError instanceof Error ? registerError.message : 'Registration failed'}</div>}
