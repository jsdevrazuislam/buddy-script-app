  ...
  const handlePost = async () => {
    ...
    try {
      ...
      if (image) {
        ...
        const { timestamp, signature, cloudName, apiKey, folder } = await postApi.getUploadUrl() as { timestamp: number; signature: string; cloudName: string; apiKey: string; folder: string };
      ...
      // 3. Create post with the image URL
      createPost({ text, imageUrl, visibility }, {
        onSuccess: () => {
          setText('');
          setImage(null);
    ...
    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        ...
        <div className="form-floating _feed_inner_text_area_box_form ">
          ...
          ></textarea>
          {
            !isCreating && <label className="_feed_textarea_label" htmlFor="floatingTextarea">
              Write something ...
      ...
      {imagePreview && (
        <div className="mt-3 mb-3 position-relative">
          ...
          <button
            type="button"
            onClick={() => { setImage(null); setImagePreview(null); fileInputRef.current && (fileInputRef.current.value = ''); }}
      ...
      <div className="_feed_inner_text_area_bottom">
        ...
        <div className="d-flex align-items-center">
          <div className="_feed_inner_text_area_visibility me-3" style={{ position: 'relative' }}>
            <select
          ...
          <div className="_feed_inner_text_area_btn">
            <button
              ...
              onClick={handlePost}
              disabled={isCreating || isUploading || (!text.trim() && !image)}
              style={{ opacity: (isCreating || isUploading) ? 0.7 : 1 }}
            >
              ...
              <span>{(isCreating || isUploading) ? 'Posting...' : 'Post'}</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="_feed_inner_text_area_bottom_mobile d-md-none d-block">
        <div className="_feed_inner_text_mobile">
          ...
          <div className="d-flex align-items-center mt-2 w-100 justify-content-between">
            <div className="_feed_inner_text_area_visibility" style={{ position: 'relative' }}>
              <select
                className="form-select-sm"
                style={{
                  border: '1px solid #eee',
